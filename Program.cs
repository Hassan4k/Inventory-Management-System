...
namespace InventorySystem
{
    class Program
    {
        ...
        public static string filepath = "E:\\Hassan PAF KIET\\Semester 1\\PROGRAM FUNDAMENTALS\\InventorySystem\\Inventory.txt";
        // Filepath of customer's cart
        public static string filepath_c = "E:\\Hassan PAF KIET\\Semester 1\\PROGRAM FUNDAMENTALS\\InventorySystem\\Cart.txt";
        ...
        static void AddToCart()
        {
            ...
            if (found == false && add_to_cart.ToUpper() != "EXIT")
            {
                Buzzer();
        ...
        static void Buzzer()
        {
            ...
            soundPlayer.SoundLocation = "E:\\Hassan PAF KIET\\Semester 1\\PROGRAM FUNDAMENTALS\\InventorySystem\\buzzer.wav";
